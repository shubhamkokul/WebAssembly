...
var real__PassEquations = asm["_PassEquations"]; asm["_PassEquations"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__PassEquations.apply(null, arguments);
};
...
Module["asm"] = asm;
var _PassEquations = Module["_PassEquations"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_PassEquations"].apply(null, arguments) };
